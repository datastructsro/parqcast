...
# Importing v19 registers its bundle into parqcast.core.registry.REGISTRY.
# Consumers look up collectors/suites via REGISTRY[version_str] rather than
# importing a flat list from this package.
