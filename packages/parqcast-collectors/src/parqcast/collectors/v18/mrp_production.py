...
class MrpProductionCollectorV18(MrpCollector[V18]):
    """``mrp_production`` surface (product_uom_id, bom_id, product_qty,
    qty_producing, state, reservation_state, three date columns,
    location_src/dest, picking_type, origin, company) is stable across v18
    and v19."""
