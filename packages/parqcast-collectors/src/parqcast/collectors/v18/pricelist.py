...
class PricelistCollectorV18(SaleCollector[V18]):
    """``product_pricelist.name`` is translatable JSONB on v18 (same as v19)."""
...
class PricelistItemCollectorV18(SaleCollector[V18]):
    """Pricelist-item columns are identical on v18 and v19."""
