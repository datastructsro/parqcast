...
class StockWarehouseCollectorV18(StockCollector[V18]):
    """Warehouse surface (id/code, lot/input/output loc refs, step config) is
    stable across v18 and v19 — SQL is identical to v19's."""
