...
class OrderpointActorV18(BaseIngester[V18]):
    """Create / update stock.warehouse.orderpoint from min/max decisions.

    ``stock_warehouse_orderpoint.supplier_id`` exists in both v18 and v19
    so the write/create payload is unchanged from v19.
    """
