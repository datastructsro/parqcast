...
class BaseModel:
    ...
    def search(self, domain: list[Any], **kwargs: Any) -> Self: ...
    def search_count(self, domain: list[Any]) -> int: ...
    def exists(self) -> Self: ...
    def ensure_one(self) -> Self: ...
    def sudo(self, flag: bool = True) -> Self: ...
    def create(self, vals: dict[str, Any] | list[dict[str, Any]]) -> Self: ...
    ...
    def __or__(self, other: "BaseModel") -> Self: ...
    def __and__(self, other: "BaseModel") -> Self: ...
    def __sub__(self, other: "BaseModel") -> Self: ...
